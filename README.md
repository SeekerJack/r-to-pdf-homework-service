...
- 支持项目内 TinyTeX，减少 Windows 中文路径造成的 LaTeX 问题
...
- R
- RStudio 或 Pandoc
- 可用的 LaTeX 环境。推荐 TinyTeX

如果你已经有项目内 `.TinyTeX`，可以把它放在本工具目录下；工具会优先使用它。
...
- `.r` 文件中是否含有姓名、学号、班级等个人信息
- 输出 PDF 是否包含真实作业答案
- 日志里是否出现本机路径

本仓库只建议发布工具代码和脱敏示例，不建议发布真实作业。
